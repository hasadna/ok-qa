...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.is_candidate'
        db.delete_column(u'user_profile', 'is_candidate')


    def backwards(self, orm):
        # Adding field 'Profile.is_candidate'
        db.add_column(u'user_profile', 'is_candidate',
