...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membership.is_special'
        db.add_column(u'user_membership', 'is_special',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Membership.is_special'
        db.delete_column(u'user_membership', 'is_special')
