...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field entities on 'Profile'
        db.delete_table(db.shorten_name(u'user_profile_entities'))
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field entities on 'Profile'
        m2m_table_name = db.shorten_name(u'user_profile_entities')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('profile', models.ForeignKey(orm[u'user.profile'], null=False)),
            ('entity', models.ForeignKey(orm[u'entities.entity'], null=False))
        ))
        db.create_unique(m2m_table_name, ['profile_id', 'entity_id'])
    ...
    models = {
        ...
        u'user.profile': {
            ...
            'entities': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['entities.Entity']", 'through': u"orm['user.Membership']", 'symmetrical': 'False'}),
