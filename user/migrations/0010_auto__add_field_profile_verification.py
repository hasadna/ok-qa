...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.verification'
        db.add_column(u'user_profile', 'verification',
                      self.gf('django.db.models.fields.CharField')(default='0', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.verification'
        db.delete_column(u'user_profile', 'verification')
    ...
    models = {
        ...
        u'user.profile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_candidate': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'locality': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['entities.Entity']", 'null': 'True'}),
