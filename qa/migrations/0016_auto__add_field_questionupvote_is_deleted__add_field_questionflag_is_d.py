...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionUpvote.is_deleted'
        db.add_column(u'qa_questionupvote', 'is_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'QuestionFlag.is_deleted'
        db.add_column(u'qa_questionflag', 'is_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Answer.is_deleted'
        db.add_column(u'qa_answer', 'is_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionUpvote.is_deleted'
        db.delete_column(u'qa_questionupvote', 'is_deleted')

        # Deleting field 'QuestionFlag.is_deleted'
        db.delete_column(u'qa_questionflag', 'is_deleted')

        # Deleting field 'Answer.is_deleted'
        db.delete_column(u'qa_answer', 'is_deleted')
