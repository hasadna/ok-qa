...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'qa_taggedquestion_sites'))

        # Removing M2M table for field sites on 'Question'
        db.delete_table(db.shorten_name(u'qa_question_sites'))

        # Removing M2M table for field sites on 'Answer'
        db.delete_table(db.shorten_name(u'qa_answer_sites'))


    def backwards(self, orm):
        # Adding M2M table for field sites on 'TaggedQuestion'
        m2m_table_name = db.shorten_name(u'qa_taggedquestion_sites')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('taggedquestion', models.ForeignKey(orm[u'qa.taggedquestion'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(m2m_table_name, ['taggedquestion_id', 'site_id'])

        # Adding M2M table for field sites on 'Question'
        m2m_table_name = db.shorten_name(u'qa_question_sites')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('question', models.ForeignKey(orm[u'qa.question'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(m2m_table_name, ['question_id', 'site_id'])

        # Adding M2M table for field sites on 'Answer'
        m2m_table_name = db.shorten_name(u'qa_answer_sites')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('answer', models.ForeignKey(orm[u'qa.answer'], null=False)),
            ('site', models.ForeignKey(orm[u'sites.site'], null=False))
        ))
        db.create_unique(m2m_table_name, ['answer_id', 'site_id'])
