...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'qa_question', 'content', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Answer.content'
        db.alter_column(u'qa_answer', 'content', self.gf('django.db.models.fields.TextField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Answer.content'
        db.alter_column(u'qa_answer', 'content', self.gf('django.db.models.fields.TextField')(max_length=500))
