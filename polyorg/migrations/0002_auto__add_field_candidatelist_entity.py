...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CandidateList.entity'
        db.add_column(u'polyorg_candidatelist', 'entity',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['entities.Entity'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CandidateList.entity'
        db.delete_column(u'polyorg_candidatelist', 'entity_id')
