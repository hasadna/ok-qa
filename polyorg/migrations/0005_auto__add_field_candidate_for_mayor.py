...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Candidate.for_mayor'
        db.add_column(u'polyorg_candidate', 'for_mayor',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Candidate.for_mayor'
        db.delete_column(u'polyorg_candidate', 'for_mayor')
