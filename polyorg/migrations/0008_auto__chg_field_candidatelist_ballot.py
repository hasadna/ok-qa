...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CandidateList.ballot'
        db.alter_column(u'polyorg_candidatelist', 'ballot', self.gf('django.db.models.fields.CharField')(max_length=5))

    def backwards(self, orm):

        # Changing field 'CandidateList.ballot'
        db.alter_column(u'polyorg_candidatelist', 'ballot', self.gf('django.db.models.fields.CharField')(max_length=4))
