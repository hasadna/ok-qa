...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'polyorg_candidatelist', 'youtube_user')

        # Adding field 'CandidateList.youtube_url'
        db.add_column(u'polyorg_candidatelist', 'youtube_url',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'polyorg_candidatelist', 'youtube_user',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CandidateList.youtube_url'
        db.delete_column(u'polyorg_candidatelist', 'youtube_url')
