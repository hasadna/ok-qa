...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CandidateList.mpg_html_report'
        db.delete_column(u'polyorg_candidatelist', 'mpg_html_report')

        # Deleting field 'CandidateList.twitter_account'
        db.delete_column(u'polyorg_candidatelist', 'twitter_account')

        # Adding field 'CandidateList.homepage_url'
        db.add_column(u'polyorg_candidatelist', 'homepage_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CandidateList.mpg_html_report'
        db.add_column(u'polyorg_candidatelist', 'mpg_html_report',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CandidateList.twitter_account'
        db.add_column(u'polyorg_candidatelist', 'twitter_account',
                      self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CandidateList.homepage_url'
        db.delete_column(u'polyorg_candidatelist', 'homepage_url')
